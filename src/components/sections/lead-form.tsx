...
export function LeadForm({ title = "Пора обсудить маршрут" }: { title?: string }) {
  return (
    <section
      id="lead-form"
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 text-base text-[#4a4e65]">
            Нажмите кнопку ниже — онлайн-ассистент подключит менеджера Oktour и
            отправит заявку напрямую туроператору.
          </p>
        </div>
